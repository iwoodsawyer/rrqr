/* cgeqpy.f -- translated by f2c (version 20041007).
...
/* Subroutine */ int cgeqpy(integer *job, integer *m, integer *n, integer *k,
...
/*     ============== */
    ...
    if (*rank > 0) {
	ctrqpy(job, m, n, k, &a[a_offset], lda, &c__[c_offset], ldc, &jpvt[1]
