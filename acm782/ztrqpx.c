/* ztrqpx.f -- translated by f2c (version 20041007).
...
/* Subroutine */ int ztrqpx(integer *job, integer *m, integer *n, integer *k,
...
/*     Get tighter bounds for the value RANK. */
    ...
    ztrqxc(job, m, n, k, &a[a_offset], lda, &c__[c_offset], ldc, &jpvt[1],
