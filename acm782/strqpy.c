/* strqpy.f -- translated by f2c (version 20041007).
...
/* Subroutine */ int strqpy(integer *job, integer *m, integer *n, integer *k,
...
/*     .. Executable Statements .. */
    ...
    /* Function Body */
    mn = min(*m,*n);
    bsprqr_1.nb = ilaenv(&c__1, "SGEQRF", " ", m, n, &c__0, &c__0, (ftnlen)6,
	     (ftnlen)1);
...
/*     Compute the initial estimate for the rank. */
    ...
    strrnk(&mn, &a[a_offset], lda, &rcond, rank, &work[1], info);
...
/*     Get tighter bounds for the value RANK. */
    ...
    strqyc(job, m, n, k, &a[a_offset], lda, &c__[c_offset], ldc, &jpvt[1],
