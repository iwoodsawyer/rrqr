/* strqpx.f -- translated by f2c (version 20041007).
...
/* Subroutine */ int strqpx(integer *job, integer *m, integer *n, integer *k,
...
/*     Get tighter bounds for the value RANK. */
    ...
    strqxc(job, m, n, k, &a[a_offset], lda, &c__[c_offset], ldc, &jpvt[1],
